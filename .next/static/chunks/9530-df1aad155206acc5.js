...
to {
  ...
  animation: ${B} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Y=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(V,null,t):t:"blank"===r?null:s.createElement(q,null,s.createElement(F,{...a}),"loading"!==r&&s.createElement(Z,null,"error"===r?s.createElement(R,{...a}):s.createElement(W,{...a})))},G=v("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;

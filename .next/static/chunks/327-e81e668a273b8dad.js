...
to {
  ...
  animation: ${q} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,G=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(Y,null,t):t:"blank"===r?null:s.createElement(B,null,s.createElement(H,{...a}),"loading"!==r&&s.createElement(Z,null,"error"===r?s.createElement(T,{...a}):s.createElement(W,{...a})))},J=v("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;

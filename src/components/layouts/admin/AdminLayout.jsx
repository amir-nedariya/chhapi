        ...
        {isMobile && (
          <header className="h-16 bg-white border-b border-slate-200/80 flex items-center justify-between px-4 flex-shrink-0 z-30 shadow-xs relative">
            ...
            <div className="flex items-center gap-2.5">
              <span className="hidden sm:inline-block text-[10px] bg-teal-50 text-teal-700 border border-teal-100 font-extrabold px-2 py-0.5 rounded-md tracking-wider uppercase whitespace-nowrap">
                Admin
              </span>
              <img
                src={

  ...
  const fetchUsers = async () => {
    try {
      ...
      if (currentRole === "ADMIN") {
        ...
        // Just as an example, fetch all based on filter for super admin too if they need it,
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="mb-6 flex flex-col items-center text-center sm:items-start sm:text-left">
        ...
        <p className="text-sm text-slate-500">View platform members and roles</p>
      </div>
                ...
                >
                  ...
                  <td className="p-4 text-center">
                    <button
                      ...
                      className="text-cyan-600 hover:text-cyan-800 hover:scale-110 transition flex items-center justify-center w-full"
                    >
                      <Eye size={18} />
                    </button>
                  </td>
        ...
        {paginatedUsers.map((u) => (
          ...
          >
            ...
            <button
              ...
              className="mt-2 w-full py-2 rounded-lg bg-cyan-50 text-cyan-700 hover:bg-cyan-100 text-sm font-semibold transition flex justify-center items-center gap-2"
            >

...
const SuperAdminSettings = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0b1224] p-4 sm:p-10 flex justify-center items-start">
      <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-8 items-start justify-center mt-6">
        
        {/* Left Column - Profile & Actions */}
        <div className="w-full lg:w-96 flex flex-col gap-6 flex-shrink-0">
          {/* Profile Card */}
          <div className="w-full bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 flex flex-col items-center gap-4 shadow-2xl transform hover:scale-[1.01] transition-all">
          ...
          {showPasswordForm && (
            <form
              className="w-full flex flex-col gap-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-5 shadow-inner"
